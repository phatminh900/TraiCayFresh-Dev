...
var UserRouter = (0, trpc_1.router)({
    addNewPhoneNumber: getUserProcedure
        ...
        var user, phoneNumber, payload, isTheSamePhoneNumber, error_1;
        var _c, _d;
    ...
    setDefaultPhoneNumber: getUserProcedure
        ...
        .mutation(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var user, phoneNumber, id, payload, phoneNumberUpdatedToDefault, updatedToDefault, error_3;
        var _c, _d;
        var ctx = _b.ctx, input = _b.input;
        return __generator(this, function (_e) {
            switch (_e.label) {
