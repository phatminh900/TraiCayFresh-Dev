...
var ProductRouter = (0, trpc_1.router)({
    getProductsPrice: trpc_1.publicProcedure
        .input(zod_1.z.object({ ids: zod_1.z.array(zod_1.z.string()) }))
        .query(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        var payload, ids, products, error_1;
        var input = _b.input;
    ...
    getProducts: trpc_1.publicProcedure.query(function () { return __awaiter(void 0, void 0, void 0, function () {
        var payload, products, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    payload = _a.sent();
                    return [4 /*yield*/, payload.find({ collection: "products" })];
                case 2:
