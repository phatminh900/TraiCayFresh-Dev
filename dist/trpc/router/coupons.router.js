...
var rateLimitMiddleware = trpc_1.getUserProcedure.use(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var req, err_1;
...
var CouponRouter = (0, trpc_1.router)({
    applyCoupon: rateLimitMiddleware
        ...
        var user, type, coupon, payload, coupons, couponInDb, isAppliedCoupon, updatedUserCart, error_1;
        var _c, _d;
        var ctx = _b.ctx, input = _b.input;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    user = ctx.user, type = ctx.type;
                    coupon = input.coupon;
                ...
                case 2:
                    ...
                    updatedUserCart = user.cart.items.map(function (_a) {
                        ...
                        if (!isAppliedCoupon) {
                            return __assign(__assign({}, rest), { product: cartProduct.id, discountAmount: couponInDb.discount, coupon: coupon, quantity: quantity, isAppliedCoupon: true });
                        }
                ...
                case 3:
                    _e.trys.push([3, 8, , 9]);
                    if (!(type === trpc_1.USER_TYPE.email)) return [3 /*break*/, 5];
                ...
                case 5:
                    if (!(type === trpc_1.USER_TYPE.phoneNumber)) return [3 /*break*/, 7];
                    return [4 /*yield*/, payload.update({
