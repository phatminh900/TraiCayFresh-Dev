...
var feedback_router_1 = __importDefault(require("./router/feedback.router"));
var order_router_1 = __importDefault(require("./router/order.router"));
var reviews_router_1 = __importDefault(require("./router/reviews.router"));
...
exports.appRouter = (0, trpc_1.router)({
    ...
    feedback: feedback_router_1.default,
    order: order_router_1.default,
    review: reviews_router_1.default
});
