...
declare namespace Cypress {
  interface Chainable<Subject> {
    ...
    loginByEmailHavingCartItem():Chainable<Subject>
    ...
    loginByEmailHavingPendingOrders():Chainable<Subject>
    loginByPhoneNumberHavingPendingOrders():Chainable<Subject>
  }
}

Cypress.Commands.add("getById", (selector, agr = []) => {
  return Array.isArray(agr)
    ? cy.get(`[data-cy=${selector}]`, ...agr)
...
Cypress.Commands.add("loginByPhoneNumberHavingCartItem", () => {
  ...
  cy.get("@login-by-phone-number-form").find("input").type("0985215845");
  cy.get("@login-by-phone-number-submit-btn").click();
  cy.get("[data-cy='otp-verification-form']").as(
    "otp-verification-container-form"
  );
...
Cypress.Commands.add("loginByEmailHavingCartItemsAndAddress", () => {
  cy.visit("/login");
  cy.get("[data-cy='input-email-login']").type("testUsercheckout@gmail.com");
  cy.get("[data-cy='input-password-login']").type("test12345");
  cy.get("[data-cy='btn-submit-login']").click();
  cy.location("pathname").should("eq", "/");
});

Cypress.Commands.add("loginByPhoneNumberHavingCartItemsAndAddress", () => {
  cy.visit("/login");
  ...
  cy.get("@login-by-phone-number-form").find("input").type("0352769981");
  cy.get("@login-by-phone-number-submit-btn").click();
  cy.get("[data-cy='otp-verification-form']").as(
    "otp-verification-container-form"
  );
...
// My orders
Cypress.Commands.add("loginByEmailHavingPendingOrders", () => {
  cy.visit("/login");
  cy.get("[data-cy='input-email-login']").type("testUserOrderWithPendingOrders@gmail.com");
  cy.get("[data-cy='input-password-login']").type("test12345");
  cy.get("[data-cy='btn-submit-login']").click();
  cy.location("pathname").should("eq", "/");
});
Cypress.Commands.add("loginByPhoneNumberHavingPendingOrders", () => {
  cy.visit("/login");
  ...
  cy.get("@login-by-phone-number-form").find("input").type("0985215844");
  cy.get("@login-by-phone-number-submit-btn").click();
  cy.get("[data-cy='otp-verification-form']").as(
    "otp-verification-container-form"
  );
