...
const OrderStatusTitleInfo = ({orderStatus}:OrderStatusTitleInfoProps) => {
    ...
    let description=" Cảm ơn bạn đã tin tưởng và đặt hàng. Chúng tôi sẽ sớm gửi ngay đơn hàng đến bạn."
...
return    <>
{orderStatus==='canceled' || orderStatus==='failed' ?      <BsFillBagXFill size={35} className='text-destructive' />:
